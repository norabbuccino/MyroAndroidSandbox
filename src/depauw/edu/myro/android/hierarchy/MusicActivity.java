...
import depauw.edu.myro.android.sandbox.Music_Beep;
import depauw.edu.myro.android.sandbox.Music_Piano;
...
public class MusicActivity extends Activity {
	...
	private String[] graphicList = {"Play a Tone -->", "Piano -->"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		graphiclist.setOnItemClickListener(new OnItemClickListener()
		{
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) 
			{
				if(position == 0)
				{
					Intent beepIntent = new Intent(MusicActivity.this, Music_Beep.class);
					startActivity(beepIntent);
				}
				// Java Docs
				else if(position == 1)
				{
					Intent pianoIntent = new Intent(MusicActivity.this, Music_Piano.class);
